	...
	<tr>		
		<td>
			...
			<table cellpadding="0" cellspacing="5" border="0" id="listaPrecos">
				...
				<tr valign="top">
					<td>
						<img src="visual/imagens/pecas/cabos.jpg" title="Cabos" align="left" />
						<h3>Cabos</h3>
						Valor: Não disponível
					</td>						
					<td>
				...
				<tr valign="top">
					<td>
						...
						<h3>Kit cilindro e pist&atilde;o</h3>
						Valor não disponível.
					</td>						
					<td>&nbsp;</td>						
				</tr>				
